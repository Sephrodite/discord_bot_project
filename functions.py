...
def add_lang(user_id, char_name, skill_name):
    ...
    if "other" in (characters[user_id][char_name]["skills"]["language"]):
        ...
        characters[user_id][char_name]["points"]=(int(characters[user_id][char_name]["skills"]["language"]["other"])-1 + int(characters[user_id][char_name]["points"]))
...
def add_art(user_id, char_name, skill_name):
    ...
    if "any" in (characters[user_id][char_name]["skills"]["arts and crafts"]):
        ...
        characters[user_id][char_name]["points"]=(int(characters[user_id][char_name]["skills"]["arts and crafts"]["any"])-5 + int(characters[user_id][char_name]["points"]))
...
def add_new(user_id, char_name, skill_name, skill_type):
    match(skill_type):
        case "language":
            ...
            if skill_name in languages["languages"]:
                pass
            else:
        ...
        case "sports":
            ...
            if skill_name in sports["sports"]:
                pass
            else:
        ...
        if char_name in characters[user_id]:
            ...
            for x in characters[user_id][char_name]["skills"]:
                ...
                if char_skill_name in characters[user_id][char_name]["skills"]:
                    ...
                    if char_skill_name == "arts and crafts":
                        msg += f"**{char_skill_name.capitalize()}:**\n"
